...
public class Estudiante {
    ...
    public @NotBlank(message = "Ingrese el nombre del estudiante") String getName() {
        return name;
    }

    public void setName(@NotBlank(message = "Ingrese el nombre del estudiante") String name) {
        this.name = name;
    }
